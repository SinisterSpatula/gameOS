...
Item {
  ...
  property string bgSource: (gamesettings.fanArt && gameData.assets.background) ? gameData.assets.background : (gameData.assets.screenshots[0]) ? gameData.assets.screenshots[0] : bgDefault
