...
FocusScope {
  ...
  readonly property var gCurrentGame: gCurrentCollection.games.get(gCalculatedIndex)//(gCurrentGameIndex)
  ...
  Component.onCompleted: {
    ...
    gamesettings.filters = api.memory.get('settingsFilters') || "All";
    ...
    if (!api.memory.has('settingsFilters')) {api.memory.set('settingsFilters', gamesettings.filters)}
  }
  ...
  Item {
    ...
    Item {
      ...
      GameGridDetails {
        ...
        gameTitleText: gCurrentGame.title
